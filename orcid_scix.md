...
![Screenshot of a search for an ORCiD.](fig/scix-orcid-search.png){alt="Screenshot of a search for an ORCiD."}
...
If any of them mention barriers to adoption, be prepared to discuss it briefly with the class. Would their situation be helped by encouraging additional claims through SciX?
:::
...
![](fig/scix-orcid-claim.png){alt="Screenshot showing the buttons for claim and delete claim in SciX."}
