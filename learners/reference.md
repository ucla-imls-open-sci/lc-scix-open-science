...
| FAIR          | **F**indable, **A**ccessible, **I**nteroperable, and **R**euseable, a [set of principles](https://force11.org/info/the-fair-data-principles/) for open data published by Wilkenson et al. in 2016 (DOI: [10.1038/sdata.2016.18](https://doi.org/10.1038/sdata.2016.18)) now colloquially generalized to most research artifacts.|
